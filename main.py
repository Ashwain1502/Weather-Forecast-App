...
def getWeather():
    ...
    #long_lat.config(text=f"{location.latitude} °N,{location.longitude} °E")
    ...
    #weather
    api = "https://api.openweathermap.org/data/2.5/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=19da29428c06c9fb81a929b1f564ff2b"
...
Seacrh_icon = PhotoImage(file="Images\Layer 6.png")
myimage_icon = Button(image=Seacrh_icon,borderwidth=0,cursor="hand2",bg="#203243",command=getWeather)
